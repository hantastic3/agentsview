...
func TestJointReportingRejectsInconsistentResolution(t *testing.T) {
	hour := reportingHourFixture("2026-07-29-13")
	hour.SchemaVersion, hour.BucketSeconds = 3, 300
	...
	_, _, err = FinalizeReportingDay(ReportingDay{SchemaVersion: 3, BucketSeconds: 300, Date: "2026-07-29", Hours: []ReportingHour{hour}})
